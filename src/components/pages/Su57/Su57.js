  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.secondpaidge}>
        <span> Cy-57</span> 
        <span> Российский многофункциональный истребитель пятого поколения, 
          созданный ОКБ имени П. О. Сухого в рамках комплексной целевой 
          программы «ПАК ФА». Самолёт разработан для замены в российских 
          ВКС тяжёлого истребителя Су-27. </span>
      </div>
    </div>
  );
};
